                    ...
                    {posts.map((post) => (
                        <Card key={post.id} className="postcard">
                            <CardHeader
                                ...
                                subheader={moment(post.date_created).format(
                            ...
                            <CardContent>
                                ...
                                <Typography
                                    ...
                                    component="p">
                                    Last Update:{" "}
                                    {moment(post.last_update).format(
                                        "MMMM Do YYYY, h:mm:ss a"
                                    )}
                                </Typography>
                                <Typography
                            ...
                            <CardActions disableSpacing>
                                ...
                                <IconButton
                                    aria-label="downvote"
                                    onClick={(e) =>
                                        this.handleDownVote(e, post.id)
                                    }>
                                    <ThumbDownIcon />{" "}
                                    {Math.abs(post.post_downvote)}
                                </IconButton>
                            </CardActions>
                        </Card>
                    ))}
